...
import {registerPresence} from '~/sockets/presence'
...
export function initSockets(httpServer, {corsOrigin, jwtSecret, userService}) {
  ...
  registerPresence(io, {userService})   // online/offline + focus/blur
  registerChat(io)                        // join/typing/message:new nếu có
  registerCallSignaling(io, auth)         // namespace /webrtc nếu bạn dùng
