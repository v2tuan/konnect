...
function ToastIncoming({ from, mode, onAccept, onDecline }) {
  return (
    <div style={{ display:'flex', alignItems:'center', gap:12 }}>
      ...
      <button
        onClick={onAccept}
        style={{ padding:'4px 8px', fontSize:12, borderRadius:6, background:'#059669', color:'#fff', border:'none', cursor:'pointer' }}
      >
        Accept
      </button>
      <button
        onClick={onDecline}
        style={{ padding:'4px 8px', fontSize:12, borderRadius:6, background:'#dc2626', color:'#fff', border:'none', cursor:'pointer' }}
      >
        Decline
      </button>
    </div>
